...
<jsp:include page="../common/menubar.jsp" />
	...
	<div class="content">
        ...
        <div class="innerOuter" style="padding:0% 10%;">
            ...
            <form id="enrollForm" method="post" action="insertAdminFaq.do">
                <table align="center" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="question" class="form-control" name="question" required></td>
                    </tr>                                       
                    <tr>
                        <th colspan="2"><label for="answer">답변</label></th>
                    </tr>
                    <tr>
                        <th colspan="2"><textarea class="form-control" required name="answer" id="answer" rows="10" style="resize:none;"></textarea></th>
                    </tr>
                </table>
                <br>
